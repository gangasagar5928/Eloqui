...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  List<Map<String, dynamic>> _ieltsScores = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    final logs = await DbHelper.instance.getDailyLogs(days: 14);
    final scores = await DbHelper.instance.getIeltsScores(limit: 10);
    if (mounted) {
      setState(() {
        _logs = logs.reversed.toList();
        _ieltsScores = scores.reversed.toList();
        _loading = false;
      });
    }
  }
